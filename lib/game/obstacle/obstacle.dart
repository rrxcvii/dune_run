...
import 'package:dune_run/game/custom/util.dart';
import 'package:dune_run/game/game_config.dart';
import 'package:dune_run/game/horizon/config.dart';
import 'package:dune_run/game/obstacle/config.dart';
import 'package:dune_run/game/obstacle/obstacle_type.dart';
...
class ObstacleManager extends PositionComponent
  ...
  void addNewObstacle(double speed) {
    ObstacleType type = getRandomNum(0.0, 1.0).round() == 0
        ? ObstacleType.palmSmall
        : ObstacleType.palmLarge;
